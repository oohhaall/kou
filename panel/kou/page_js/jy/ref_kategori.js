    ...
    var bak = 0;
     ...
     $.ajax({
            ...
            success: function(sonuc, textStatus, jqXHR)
            {
                ...
                $(".kategori_list").load("piston/control/"+glob_page_uri+"_load.php?load_max="+$(".list_comp").attr("goster_num"));
...
function slider_sil(scroll_id,item_id,height_id,form_id,info_field){
    var confirm_ = confirm("Kategoriyi Silmek Istediginizden Eminmisiniz ?");
    if(confirm_){
