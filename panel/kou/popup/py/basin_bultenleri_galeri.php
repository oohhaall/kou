...
extract($_POST);
extract($_GET);
$dt_table = "basinbultenlerigaleri";
...
<div class="main_full_pop">
 ...
 <ul class="todo-list detay_popup" post_uri="basin_bultenleri_galeri" dt_table="<?php echo $dt_table; ?>">
        ...
        <?php } } ?>
         ...
         <!-- <button class="btn btn-default btn-block daha_fazla" onclick="daha_fazla_goster('list_comp')">Daha Fazla Göster</button>       -->
              ...
              <script type="text/javascript">
                var glob_page_uri_pop = "<?php echo $page_uri; ?>";
