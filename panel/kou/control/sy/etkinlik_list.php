...
INSERT INTO seranitguncel(tarih, baslik_tr, baslik_en, baslik_de, baslik_es, baslik_fr, baslik_ru, baslik_it, aciklama_tr, aciklama_en, aciklama_de, aciklama_es, aciklama_fr, aciklama_ru, aciklama_it) VALUES ()
		*/
	$ekle_veri = $db->prepare("INSERT INTO $dt_table(tarih, baslik_tr, baslik_en, baslik_de, baslik_es, baslik_fr, baslik_ru, baslik_it, aciklama_tr, aciklama_en, aciklama_de, aciklama_es, aciklama_fr, aciklama_ru, aciklama_it) VALUES (:tarih,:baslik_tr,:baslik_en,:baslik_de,:baslik_es,:baslik_fr,:baslik_ru,:baslik_it,:aciklama_tr,:aciklama_en,:aciklama_de,:aciklama_es,:aciklama_fr,:aciklama_ru,:aciklama_it)");
		...
		if($ekle_veri->rowCount()>0){
			...
			<?php
				...
				$ekle_veri = $db->prepare("UPDATE $dt_table SET tarih=:tarih, baslik_tr=:baslik_tr, baslik_en=:baslik_en, baslik_de=:baslik_de, baslik_es=:baslik_es, baslik_fr=:baslik_fr, baslik_ru=:baslik_ru, baslik_it=:baslik_it, aciklama_tr=:aciklama_tr, aciklama_en=:aciklama_en, aciklama_de=:aciklama_de, aciklama_es=:aciklama_es, aciklama_fr=:aciklama_fr, aciklama_ru=:aciklama_ru, aciklama_it=:aciklama_it WHERE id=:uid");
