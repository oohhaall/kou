...
if($sid == 0 && @$islem!="sil"){
			...
			$ekle_veri = $db->prepare("INSERT INTO $db_tab(baslik_tr, baslik_en, baslik_de, baslik_es, baslik_fr, baslik_ru, baslik_it) VALUES (:baslik_tr,:baslik_en,:baslik_de,:baslik_es,:baslik_fr,:baslik_ru,:baslik_it)");
				  ...
				  <div class="alert alert-success alert-dismissable">
                    ...
                    Kategori başarıyla eklendi listeden detaylı görüntüleme yapabilirsiniz.
                  </div>
							<?php
                   ...
                   Kategori eklenemiyor lütfen yetkililere sorun hakkında bilgilendirme yapınız.
                  </div>
						<?php
					}
			...
			$sor_ref->execute();
				...
				$ekle_veri = $db->prepare("UPDATE $db_tab SET baslik_tr=:baslik_tr, baslik_en=:baslik_en, baslik_de=:baslik_de, baslik_es=:baslik_es, baslik_fr=:baslik_fr, baslik_ru=:baslik_ru, baslik_it=:baslik_it WHERE id=:id");
				  ...
				  <div class="alert alert-success alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <h4>	<i class="icon fa fa-check"></i> Başarılı!</h4>
                    Kategori başarıyla düzenlendi listeden detaylı görüntüleme yapabilirsiniz.
                  </div>
							<?php
                    ...
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <h4><i class="icon fa fa-warning"></i> Hata!</h4>
                   Kategori düzenlenemiyor lütfen yetkililere sorun hakkında bilgilendirme yapınız.
                  </div>
						<?php
					}
		}else{  
				...
				?>
                    ...
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <h4>	<i class="icon fa fa-check"></i> Başarılı!</h4>
                    Kategori başarıyla slindi listeden detaylı görüntüleme yapabilirsiniz.
                  </div>
				<?php
