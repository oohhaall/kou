...
[email] => dsa@sc.c 
[telefon] => dsa 
[url] => https://www.mastercard.us/en-us.html ) Array ( [slider_resim] => Array ( [name] => 1b7fb5fb9e - Kopya - Kopya.jpg [type] => image/jpeg [tmp_name] => D:\wamp\tmp\php3901.tmp [error] => 0 [size] => 154687 ) ) 
	*/
		$dt_table = "personel";
		if($sid == 0 && @$islem!="sil"){
				$isim_s ="";
				...
				<div class="alert alert-warning alert-dismissable">
                   ...
                   Lütfen jpeg,png,gif,bmp Formatında bir resim ekleyiniz.
					...
					$ekle_veri = $db->prepare("INSERT INTO $dt_table(sira,isim, email, oda, telefon, arastirma_alani_tr, arastirma_alani_en, url, resim) SELECT MAX(sira)+1 as sira,:isim as isim,:email as email,:oda as oda,:telefon as telefon,:arastirma_alani_tr as arastirma_alani_tr,:arastirma_alani_en as arastirma_alani_en,:url as url,:resim as resim,:anabilim_dali as anabilim_dali FROM $dt_table WHERE type=:type");
