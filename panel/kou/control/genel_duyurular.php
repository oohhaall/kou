	...
	extract($_POST);
		...
		if($sid == 0 && @$islem!="sil"){
				...
				$duyuru_ek = array();
					...
					$ekle_veri = $db->prepare("INSERT INTO $dt_table(baslik_tr, baslik_en, aciklama_tr, aciklama_en, tarih, ek_tr, ek_en, yazar) VALUES(:baslik_tr,:baslik_en,:aciklama_tr,:aciklama_en,:tarih,:ek_tr,:ek_en,:yazar)");
