...
?>
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-files-o"></i>Bölüm Duyuruları</a></li>
 ...
 <ul class="todo-list up_list_comp" post_uri="<?php echo $up_page; ?>" dt_table="<?php echo $dt_table; ?>" goster_num="20">
                    ...
                    <?php 
                      ...
                      $sor_slider = $db->prepare("SELECT * FROM $dt_table WHERE type='2' ORDER BY tarih DESC LIMIT 0,20");
                      $sor_slider->execute();
