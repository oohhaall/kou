        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-files-o"></i>Referans Şehir</a></li>
                ...
                <form role="form" id="a_slider_ekle" method="post" enctype="multipart/form-data" onsubmit="return slider_ekle('ana_slider_ekle','a_slider_ekle','info_field','ana_slider_ekle');">
                    ...
                    <div class="form-group">  
                        <select class="form-control" name="ulke" id="ref_ulk">
                          <?php 
                              $sor_ulk = $db->prepare("SELECT * FROM refulke ORDER BY baslik_tr ASC");
                              $sor_ulk->execute();
 ...
 <ul class="todo-list kategori_list" post_uri="ref_sehir_up" dt_table="refsehir" goster_num="10">

                    <?php 

                      $sor_slider = $db->prepare("SELECT * FROM refsehir ORDER BY baslik_tr ASC");
                      $sor_slider->execute();
