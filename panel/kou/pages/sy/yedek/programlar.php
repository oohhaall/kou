  <section class="content-header">
          <h1>
            Sayfa
            <small>Program İçerik Listesi</small>
          </h1>
          <ol class="breadcrumb">
        ...
        <section class="content" id="ppassd">
          ...
          <div class="box" id="grup_list_slider">
            ...
            <div class="box-body" id="galeri_grub_id">
                  <ul class="todo-list list_comp_2" post_uri='program_icerik'>
                    ...
                    <li id="<?php echo "list_update_".$value["id"]; ?>" sira='<?php echo $value["sira"]; ?>' m_id='g_<?php echo $value["id"]; ?>'>
                      ...
                      <div class="tools">
                        ...
                        <i class="fa fa-trash-o" onclick="galeri_grup_sil_ana('<?php echo $value["id"]; ?>','program_list','info_field_2','galeri_grub_form')"></i>
                      </div>
                    </li>
                    <?php } } ?>
                  </ul>
           ...
           <div id="info_field_2">
              ...
              <div class="ekle_slayt" id="galeri_grub_ekle">
                ...
                <!-- form start -->
                <form role="form" id="galeri_grub_form" method="post" enctype="multipart/form-data" onsubmit="return galeri_grup_ekle('program_list','galeri_grub_form','info_field_2','galeri_grub_ekle');">
                      <input type="hidden" name="tip" value="0">
                      <input type="hidden" name="sid" value="0">
                  <div class="box-body">
                                                             <div class="form-group">
                      <label>Program Eğitmen Filtresi</label>
                      <select class="form-control" name="filt_select">
                                 <option value='0'>Lütfen Eğitmen Seçin</option>

                      <?php
                          $sor_page_list = $db->query("SELECT * FROM ekip WHERE durum='1' ORDER BY sira DESC");
                  ...
                  <!--   <p class="help-block">Programlarda görünmesini istediğiniz eğitmeni sol sütundan sağ sütuna ekleyerek görünür yapabilirsiniz.</p> -->
  ...
  <div class="full_galeri_list">
              <div class="box box-primary" id="list_slayt">
                ...
                <div class="box-body">
             <ul class="todo-list list_comp fiinns_c" post_uri='alt_kt_program' g__id="">

                    <?php 

                      $sor_slider = $db->prepare("SELECT * FROM program WHERE tur=2 ORDER BY sira DESC");
                      $sor_slider->execute();
              ...
              ?>
                   ...
                   <li id="<?php echo "list_update_".$value["id"]; ?>" ust_kt='<?php echo $value["ust_kt"]; ?>' sira='<?php echo $value["sira"]; ?>' m_id='<?php echo $value["id"]; ?>'>
                    ...
                    <?php  } ?>
                      ...
                      <div class="tools">
                        <i class="fa fa-edit" onclick="alt_kt_duz('a_slider_ekle','<?php echo $value["id"]; ?>','program_list')"></i>
                ...
                <div class="box-footer clearfix no-border">
                  <button class="btn btn-default pull-right"  onclick="scroll_slow('ana_slider_ekle','ppassd','a_slider_ekle')"><i class="fa fa-plus"></i> İçerik Ekle</button>
                </div>
              </div><!-- /.box -->
...
-->
               ...
               <form role="form" id="alt_kt" method="post" enctype="multipart/form-data" onsubmit="return galeri_grup_ekle_alt('program_list','alt_kt','info_field_2','ana_slider_ekle');">
                  ...
                  <!--   <p class="help-block">Programlarda görünmesini istediğiniz eğitmeni sol sütundan sağ sütuna ekleyerek görünür yapabilirsiniz.</p> -->
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label for="exampleInputEmail1">Resim</label>
                      <input type="file" name="resim" id="exampleInputFile">
                      <img src="" style="display:inline-block;" width="150" height="150">
                       <button type="button" onclick="" class="img-del"><i class="fa fa-remove"></i></button>
                      <p class="help-block">İçerik için lütfen boyutları  700 x 280 olan bir resim seçin</p>
                    </div>
                     <div class="form-group">
