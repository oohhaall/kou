...
<div style="display: none;" m_id='<?php echo $value["id"]; ?>'><?php echo $value["paragraf"]; ?></div>
 ...
 <div id="info_field">
              ...
              <div class="ekle_slayt" id="ana_slider_ekle">
                ...
                <!-- form start -->
                <form role="form" id="slider_ekles" method="post" enctype="multipart/form-data" onsubmit="return white_paper('white_paper','slider_ekles','info_field','ana_slider_ekle');">
