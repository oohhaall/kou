  <section class="content-header">
          <h1>
            Sayfa
            <small>İnsan Kaynakları Gelişimi İçerik Listesi</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-files-o"></i>Sayfa</a></li>
            <li class="active">İnsan Kaynakları Gelişimi</li>
          </ol>
        </section>
        ...
        <section class="content" id="ppassd">
          ...
          <div class="box" id="grup_list_slider">
            ...
            <div class="box-body" id="galeri_grub_id">
                  <ul class="todo-list list_comp_2" post_uri='insan_kaynaklari'>
                    ...
                    <li id="<?php echo "list_update_".$value["id"]; ?>" sira='<?php echo $value["sira"]; ?>' m_id='g_<?php echo $value["id"]; ?>'>
                      ...
                      <div class="tools">
                        ...
                        <i class="fa fa-trash-o" onclick="galeri_grup_sil_ana('<?php echo $value["id"]; ?>','insan_kaynaklari','info_field_2','galeri_grub_form')"></i>
                      </div>
                    </li>
                    <?php } } ?>
                  </ul>
           ...
           <div id="info_field_2">
              ...
              <div class="ekle_slayt" id="galeri_grub_ekle">
                ...
                <!-- form start -->
                <form role="form" id="galeri_grub_form" method="post" enctype="multipart/form-data" onsubmit="return galeri_grup_ekle('insan_kaynaklari','galeri_grub_form','info_field_2','galeri_grub_ekle');">
  ...
  <div class="full_galeri_list">
             ...
             <ul class="todo-list list_comp fiinns_c" post_uri='alt_kategori_list' g__id="">
                    ...
                    <?php 
                      ...
                      $sor_slider = $db->prepare("SELECT * FROM insan_kaynaklari WHERE tur=2 ORDER BY sira DESC");
                      $sor_slider->execute();
              ...
              ?>
                   ...
                   <li id="<?php echo "list_update_".$value["id"]; ?>" ust_kt='<?php echo $value["ust_kt"]; ?>' sira='<?php echo $value["sira"]; ?>' m_id='<?php echo $value["id"]; ?>'>
                     ...
                     <!-- <input type="checkbox" value="" name=""> -->
                      ...
                      <div class="tools">
                        <i class="fa fa-edit" onclick="alt_kt_duz('a_slider_ekle','<?php echo $value["id"]; ?>','insan_kaynaklari')"></i>
...
-->
               ...
               <form role="form" id="alt_kt" method="post" enctype="multipart/form-data" onsubmit="return galeri_grup_ekle_alt('insan_kaynaklari','alt_kt','info_field_2','ana_slider_ekle');">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label for="exampleInputEmail1">İçerik</label>
                      <textarea placeholder="İçerik" name="icerik" id="ck_2" rows="3" class="form-control" required=""></textarea>
