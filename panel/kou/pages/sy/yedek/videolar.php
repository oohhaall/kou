        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-files-o"></i>Videolar</a></li>
                ...
                <form role="form" id="a_slider_ekle" method="post" enctype="multipart/form-data" onsubmit="return biliyormusun_ekle('bunlari_biliyormusun','a_slider_ekle','info_field','ana_slider_ekle');">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="icerik" class="form-control" id="exampleInputEmail1" placeholder="Video Kodu" required="">
                    </div>

                      <div class="form-group">
                      <label>Video Açıklama</label>
                      <textarea name="aciklama" maxlength="255" class="form-control" id="exampleInputEmail1" placeholder="Video Açıklama"></textarea>
                    </div>
