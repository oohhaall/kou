  <section class="content-header">
          <h1>
            Sayfa
            <small>Finans İçerik Listesi</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-files-o"></i>Sayfa</a></li>
            <li class="active">Finans</li>
          </ol>
        </section>
        ...
        <section class="content" id="ppassd">
          ...
          <div class="box" id="grup_list_slider">
            ...
            <div class="box-body" id="galeri_grub_id">
                  <ul class="todo-list list_comp_2" post_uri='finans_grup'>
                    ...
                    <li id="<?php echo "list_update_".$value["id"]; ?>" sira='<?php echo $value["sira"]; ?>' m_id='g_<?php echo $value["id"]; ?>'>
                      ...
                      <div class="tools">
                        ...
                        <i class="fa fa-trash-o" onclick="galeri_grup_sil_ana('<?php echo $value["id"]; ?>','finans_list','info_field_2','galeri_grub_form')"></i>
                      </div>
                    </li>
                    <?php } } ?>
                  </ul>
           ...
           <div id="info_field_2">
              ...
              <div class="ekle_slayt" id="galeri_grub_ekle">
                ...
                <!-- form start -->
                <form role="form" id="galeri_grub_form" method="post" enctype="multipart/form-data" onsubmit="return galeri_grup_ekle('finans_list','galeri_grub_form','info_field_2','galeri_grub_ekle');">
              ...
              ?>
                   ...
                   <li id="<?php echo "list_update_".$value["id"]; ?>" ust_kt='<?php echo $value["ust_kt"]; ?>' sira='<?php echo $value["sira"]; ?>' m_id='<?php echo $value["id"]; ?>'>
                     ...
                     <!-- <input type="checkbox" value="" name=""> -->
                      ...
                      <!-- General tools such as edit or delete-->
                      <div class="list_active_control">
                      <div class="slider-track g <?php echo ($value["durum"]==1)?"acik_on":NULL; ?>" onclick='gunc_durum("<?php echo $value["id"]; ?>","g")' item_id="<?php echo $value["id"]; ?>" post_type="finans">
                          <div class="slider-handle"></div>
                        </div>
                        </div>
                      <div class="tools">
                        <i class="fa fa-edit" onclick="alt_kt_duz('a_slider_ekle','<?php echo $value["id"]; ?>','finans_list')"></i>
...
-->
               ...
               <form role="form" id="alt_kt" method="post" enctype="multipart/form-data" onsubmit="return galeri_grup_ekle_alt('finans_list','alt_kt','info_field_2','ana_slider_ekle');">
