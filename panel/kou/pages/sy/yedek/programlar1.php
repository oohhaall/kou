                  ...
                  <ul class="todo-list list_comp_2" post_uri='program_icerik'>
                    ...
                    <li id="<?php echo "list_update_".$value["id"]; ?>" sira='<?php echo $value["sira"]; ?>' m_id='g_<?php echo $value["id"]; ?>'>
                      ...
                      <div class="tools">
                        ...
                        <i class="fa fa-trash-o" onclick="galeri_grup_sil('<?php echo $value["id"]; ?>','finans_list','info_field_2','galeri_grub_ekle')"></i>
                      </div>
                    </li>
                    <?php } } ?>
                  </ul>
              ...
              ?>
                   ...
                   <li id="<?php echo "list_update_".$value["id"]; ?>" ust_kt='<?php echo $value["ust_kt"]; ?>' sira='<?php echo $value["sira"]; ?>' m_id='<?php echo $value["id"]; ?>'>
                     ...
                     <!-- <input type="checkbox" value="" name=""> -->
                      ...
                      <!-- General tools such as edit or delete-->
                      <div class="list_active_control">
                      <div class="slider-track g <?php echo ($value["durum"]==1)?"acik_on":NULL; ?>" onclick='gunc_durum("<?php echo $value["id"]; ?>","g")' item_id="<?php echo $value["id"]; ?>" post_type="program">
                          <div class="slider-handle"></div>
                        </div>
                        </div>
                      <div class="tools">
                        <i class="fa fa-edit" onclick="alt_kt_duz('a_slider_ekle','<?php echo $value["id"]; ?>','galeri')"></i>
...
-->
               ...
               <form role="form" id="alt_kt" method="post" enctype="multipart/form-data" onsubmit="return galeri_grup_ekle('program_list','alt_kt','info_field_2','ana_slider_ekle');">
                      <input type="hidden" name="tip" value="1">
