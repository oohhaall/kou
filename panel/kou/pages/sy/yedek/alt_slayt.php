        ...
        <section class="content-header">
          <h1>
            Alt Slayt
            <small>Slayt Listesi</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-files-o"></i>Slayt</a></li>
            <li class="active">Slayt Listesi</li>
          </ol>
        </section>
  ...
  <!-- TO DO List -->
              <div class="box box-primary" id="list_slayt">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Slayt Listesi</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
 <ul class="todo-list list_comp" post_uri='alt_slider'>
...
<p style="display: none;" m_id='<?php echo $value["id"]; ?>'></p>
                      ...
                      <div class="tools">
                        ...
                        <i class="fa fa-trash-o" onclick="slider_sil('<?php echo $value["id"]; ?>','alt_slider','info_field','a_slider_ekle')"></i>
                      </div>
                    </li>
        <?php } } ?>
  </ul>
                ...
                <div class="box-footer clearfix no-border">
                  <button class="btn btn-default pull-right"  onclick="scroll_slow('ana_slider_ekle','list_slayt','a_slider_ekle')"><i class="fa fa-plus"></i> Slayt Ekle</button>
                </div>
              </div><!-- /.box -->
 ...
 <div id="info_field">
              ...
              <div class="ekle_slayt" id="ana_slider_ekle">
                ...
                <!-- form start -->
                <form role="form" id="a_slider_ekle" method="post" enctype="multipart/form-data" onsubmit="return slider_ekle('alt_slider','a_slider_ekle','info_field','ana_slider_ekle');">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group" style="display: none;">
                      ...
                      <textarea placeholder="Paragraf" name="paragraf" rows="3" class="form-control"></textarea>
                    </div>
