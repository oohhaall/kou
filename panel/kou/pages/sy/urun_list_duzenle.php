...
<div id="info_field">
 ...
 <label>Yeni Ürün</label><br>
  <label style="font-weight: normal;"><input type="checkbox" name="yeni_urun" <?php echo ($oku_urun["yeni"]==1)?"checked":NULL; ?>> Yeni Ürün Olarak Göster</label>
</div>
