  ...
  <!-- TO DO List -->
              <div class="box box-primary" id="list_içerik">
                <div class="box-header">
                  ...
                  <h3 class="box-title">İletişim Listesi</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
 <ul class="todo-list list_comp" post_uri="<?php echo $page_list; ?>" dt_table="<?php echo $table; ?>" goster_num="10">

                    <?php 

                      $sor_slider = $db->prepare("SELECT * FROM $table ORDER BY sra DESC LIMIT 0,10");
                      $sor_slider->execute();
                   ...
                   <li id="<?php echo "list_update_".$value["id"]; ?>" sira='<?php echo $value["sra"]; ?>' m_id='<?php echo $value["id"]; ?>'>
                     ...
                     <!-- <input type="checkbox" value="" name=""> -->
                      ...
                      <span class="text">
                            ...
                            <m  m_id='<?php echo $value["id"]; ?>' style="display: none"><?php echo $value["mail"]; ?></m>
        ...
        <?php } } ?>
          ...
          <button class="btn btn-default btn-block daha_fazla" onclick="daha_fazla_goster('list_comp')">Daha Fazla Göster</button>       
                ...
                <div class="box-footer clearfix no-border">
                  <button class="btn btn-default pull-right"  onclick="scroll_slow_slider('ana_slider_ekle','list_içerik','a_slider_ekle')"><i class="fa fa-plus"></i> İletişim Ekle</button>
                </div>
              </div><!-- /.box -->
 ...
 <div id="info_field">
              ...
              <div class="ekle_içerik" id="ana_slider_ekle">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">İletişim Ekle</h3>
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" required="" name="mail" class="form-control" id="exampleInputEmail1" placeholder="Mail">
