<?php
    ...
    $dt_table = "koleksiyonlar";
 ?>
        <section class="content-header">
          <h1>
            Koleksiyonlar
            <small>Koleksiyon Listesi</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-files-o"></i>Koleksiyonlar</a></li>
            <li class="active">Koleksiyon Listesi</li>
          </ol>
        </section>
  ...
  <!-- TO DO List -->
              <div class="box box-primary" id="list_slayt">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Koleksiyon Ekle</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
