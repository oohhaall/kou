 ...
 <section class="content">
  <!-- TO DO List -->
              <div class="box box-primary" id="list_slayt">
                ...
                <div class="box-body">
 <ul class="todo-list list_comp" post_uri="slayt_list" dt_table="slayt" goster_num="10">

                    <?php 

                      $sor_slider = $db->prepare("SELECT * FROM slayt ORDER BY sra DESC LIMIT 0,10");
                      $sor_slider->execute();
        ...
        <?php } } ?>
          ...
          <button class="btn btn-default btn-block daha_fazla" onclick="daha_fazla_goster('list_comp')">Daha Fazla Göster</button>       
                ...
                <div class="box-footer clearfix no-border">
                  <button class="btn btn-default pull-right"  onclick="scroll_slow_slider('ana_slider_ekle','list_slayt','a_slider_ekle')"><i class="fa fa-plus"></i> Slayt Ekle</button>
                </div>
              </div><!-- /.box -->
                       ...
                       foreach ($dil_text as $dil_key => $dil_val) {
                          $class = ($dil_key=="tr")?"active":NULL;  ?>
                             <div class="tab-pane <?php echo $class; ?>" id="aciklama_<?php echo $dil_key; ?>">
                                 <input type="text" name="aciklama_<?php echo $dil_key; ?>" class="form-control" id="exampleInputEmail1" placeholder="<?php echo $dil_val; ?>">
