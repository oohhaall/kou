        ...
        <?php } } ?>
          ...
          <button class="btn btn-default btn-block daha_fazla" onclick="daha_fazla_goster('up_lo')">Daha Fazla Göster</button>       
                ...
                <div class="box-footer clearfix no-border">
                  <button class="btn btn-default pull-right"  onclick="scroll_slow_slider('ana_slider_ekle','list_içerik','a_slider_ekle')"><i class="fa fa-plus"></i> Etkinlik Ekle</button>
                </div>
              </div><!-- /.box -->
