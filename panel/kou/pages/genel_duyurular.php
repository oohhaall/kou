<?php 
    ...
    $dt_table = "duyurular";
    $up_page = "genel_duyurular";
?>
        <section class="content-header">
          <h1>
            Genel Duyurular
            <small>Duyuru Listesi</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-files-o"></i>Genel Duyurular</a></li>
            <li class="active">Duyuru Listesi</li>
          </ol>
        </section>
 ...
 <ul class="todo-list up_list_comp" post_uri="<?php echo $up_page; ?>" dt_table="<?php echo $dt_table; ?>" goster_num="20">
                    ...
                    <?php 
                      ...
                      $sor_slider = $db->prepare("SELECT * FROM $dt_table WHERE type='1' ORDER BY tarih DESC LIMIT 0,20");
                      $sor_slider->execute();
