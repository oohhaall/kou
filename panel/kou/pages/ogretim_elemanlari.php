 ...
 <section class="content">
  <!-- TO DO List -->
              <div class="box box-primary" id="list_slider">
                ...
                <div class="box-body">
 <ul class="todo-list list_comp" post_uri="ogretim_elemanlari" dt_table="<?php echo $dt_table; ?>" goster_num="10">

                    <?php 

                      $sor_slider = $db->prepare("SELECT * FROM $dt_table WHERE type='2' ORDER BY sira DESC LIMIT 0,10");
                      $sor_slider->execute();
